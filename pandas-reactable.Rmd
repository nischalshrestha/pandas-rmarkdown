...
I will use the raw `weather.csv` dataset from the `nycflights13` [package](https://github.com/hadley/nycflights13) to demonstrate how Python dataframes look different and how we can make them look pretty when printing in RMarkdown.
